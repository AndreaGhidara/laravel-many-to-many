            ...
            <div class="col">
                <form action="{{route('admin.products.store')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="imgPath" class="form-control" id="imgPath" value="{{ old('imgPath') }}">
                        @error("imgPath")
                            <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="link_to_project"  class="form-control" id="link_to_project" value="{{ old('link_to_project')}}">
